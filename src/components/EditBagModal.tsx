...
export default function EditBagModal({
  ...
  const [bagInput, setBagInput] = React.useState<BagInput>({
  ...
  const handleChange = (field: BagField, value: string) => {
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          <View style={styles.modalContent}>
            ...
            {(['width', 'height', 'depth'] as BagField[]).map((field) => (
              <TextInput
                key={field}
